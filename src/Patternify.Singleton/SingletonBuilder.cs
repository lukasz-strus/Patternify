...
internal sealed class SingletonBuilder
{
    ...
    public void SetUsings(ClassDeclarationSyntax classDeclaration)
    {
        var usings = classDeclaration
    ...
    public void SetNamespace(ClassDeclarationSyntax classDeclaration) =>
        _namespace = classDeclaration.FirstAncestorOrSelf<NamespaceDeclarationSyntax>()?.Name.ToString() ?? string.Empty;

    public void SetAccessModifier(ClassDeclarationSyntax classDeclaration) =>
        _accessModifier = classDeclaration.Modifiers.First().Text;

    public void SetClassSignature(ClassDeclarationSyntax classDeclaration) =>
    ...
    public void Clear() => _usings = _namespace = _accessModifier = _className = string.Empty;
}